...
public static class GameResourcePath 
{
	...
	public static readonly string PANEL_SHOP = "UI/Home/PanelShop";
	#endregion
	#region POPUP
	...
	public static readonly string UI2 = "UI/UI2";
	public static readonly string UI3 = "UI/UI3";
	...
	public static readonly string ITEM_EQUIPMENT_CRAFT_VIEW = "MISC/EquipmentCraftView";
