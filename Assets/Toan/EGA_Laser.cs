...
public class EGA_Laser : MonoBehaviour
{
    ...
    public void SetTarget(Vector3 _posTarget) {
        this.Target = _posTarget;
    }

    public void SetTimeLive(float _timeLive) {
    ...
    void Update()
    {
        ...
        if (Laser != null && UpdateSaver == false)
        {
            ...
            if (Physics.Raycast(transform.position, direction, out hit, MaxLength))//CHANGE THIS IF YOU WANT TO USE LASERRS IN 2D: if (hit.collider != null)
            {
